import sys
sys.path.append('/home/erdos/workspace/pylot/dependencies/')
sys.path.append('/home/erdos/workspace/pylot/dependencies/lanenet/')
...
sys.path.append('/home/erdos/workspace/pylot/dependencies/CARLA_0.9.10.1/PythonAPI/carla/')
sys.path.append('/home/erdos/workspace/pylot/dependencies/CARLA_0.9.10.1/PythonAPI/')
import signal
...
def driver():
    ...
    print('pylot.flags.must_add_lidar_sensor()', pylot.flags.must_add_lidar_sensor())
    ...
    imu_stream = None
    print('pylot.flags.must_add_imu_sensor()', pylot.flags.must_add_imu_sensor())
