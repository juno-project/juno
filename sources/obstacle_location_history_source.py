...
class MyState:
    def __init__(self, cfg):
        ...
        self.obstacles_tracking_msg_path = cfg['obstacles_msg']
...
class MySrc(Source):
    ...
    def run(self, _ctx, state):
        ...
        obstacles_msg = pickle.load(open(state.obstacles_tracking_msg_path, 'rb'))
        vehicle_transform = pickle.load(
            open(state.vehicle_transform_path, 'rb'))
        msg = (
