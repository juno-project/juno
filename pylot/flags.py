...
flags.DEFINE_string('log_file_name', 'pylot.log', 'Name of the log file')
flags.DEFINE_string('csv_log_file_name', 'pylot.csv',
...
flags.DEFINE_bool('perfect_obstacle_detection', True,
                  'True to enable perfect obstacle 2D detection')
flags.DEFINE_bool(
    'simulator_obstacle_detection', False,
...
flags.DEFINE_bool('perfect_obstacle_tracking', True,
...
flags.DEFINE_bool('perfect_lane_detection', True,
...
flags.DEFINE_bool('log_traffic_light_detector_output', True,
