...
class ImageCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('x', self.features.conv1.state_dict())
        # print('xx', x)
        # state = {'conv1':self.features.conv1.state_dict(), 'x':x}
        # torch.save(state, '/home/erdos/workspace/pylot/neat/sample/conv1_x.pth')
